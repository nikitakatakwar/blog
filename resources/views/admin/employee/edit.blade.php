                                ...
                                <div class="row layout-top-spacing" id="cancel-row">
                                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                                        <div class="widget-content widget-content-area br-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h5 class="mt-4 ml-4">Edit Employee User</h5>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="breadcrumb-five pull-right mt-3 mr-3">
                                                        <ul class="breadcrumb">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-12">
                                                    <form method="POST" action="{{ route('employee.update',$user->id) }}" autocomplete="off" class="p-5">
                                                        @csrf
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="phone_number"
                                                                        value="{{ $user->phone_number->first()->number }}" class="form-control"
