                                        ...
                                        <div class="row inv--detail-section">
                                            ...
                                            <div class="col-sm-7 align-self-center">
                                                ...
                                                <p class="inv-customer-name">Shop Name :
                                                    {{ $customer->customers->store_name }}</p>
                                                ...
                                                <p class="inv-street-addr">
                                                    {{ $customer->customers->gstin? "Customer GSTIN# ".$customer->customers->gstin:"" }}
                                                </p>
                                                <p class="inv-street-addr">
                                                    {{ $customer->customers->gstin? "Customer Place of Supply: ".$customer->customers->pos:"" }}
                                                </p>
                                            </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>1</td>
                                                                <td>{{ $customer->customers->package->title }}
                                                                </td>
                                                                <td class="text-right">1</td>
                                                                <td class="text-right">
                                                                    ₹{{ $customer->customers->package->price }}
                                                                </td>
                                                                <td class="text-right">
                                                                    ₹{{ $customer->customers->package->price }}
                                                                </td>
