                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <h5> {{ $customer->customers->package->title }}
                                                                    </h5>
                                                                </td>
                                                                <td>
                                                                    <h5>Rs.{{ $customer->customers->package->price }}
                                                                    </h5>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <h5>Rs.{{ $customer->customers->package->price *  ($gst->value/100) }}
                                                                    </h5>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <h5>
                                                                        Rs.{{ $customer->customers->package->price +  ($customer->customers->package->price *  ($gst->value/100))}}
                                                                    </h5>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 pb-3">
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-primary" id="buy_now"
                                                        data-passing-amout="{{ $customer->customers->package->price }}"
                                                        data-amount="{{ $customer->customers->package->price +  ($customer->customers->package->price *  ($gst->value/100)) }}"
                                                        data-id={{ $customer->customers->package->id }}>Buy
                                                        Now</a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <form method="POST"
                                                        ...
                                                        <input type="hidden" name="amount"
                                                            value="{{ $customer->customers->package->price }}"> 
                                                    <input type="hidden" name="total_amount"
                                                            value="{{ $customer->customers->package->price +  ($customer->customers->package->price *  ($gst->value/100)) }}"> 
                                                     <input type="hidden" name="tax"
                                                            value="{{ $customer->customers->package->price *  ($gst->value/100) }}">
